...
export function Patient() {
  ...
  const handleAppointmentSubmit = async (appointmentData) => {
    ...
    try {
      ...
      // Here you would call your appointment booking API
      // await bookAppointment(sanitizedAppointmentData);
...
//         doctor: sanitizeInput(appointmentData.doctor),
//         date: appointmentData.date,
//         time: appointmentData.time,
//         reason: sanitizeInput(appointmentData.reason)
//       };

//       console.log('Booking appointment:', sanitizedAppointmentData);
